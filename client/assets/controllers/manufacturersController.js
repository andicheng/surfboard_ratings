app.controller('manufacturersController', ['$scope','usersFactory','surfboardsFactory', '$location','$routeParams', function($scope, usersFactory, surfboardsFactory, $location, $routeParams) {
